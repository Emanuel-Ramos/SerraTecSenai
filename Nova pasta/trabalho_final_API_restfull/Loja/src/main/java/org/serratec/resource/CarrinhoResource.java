...
import org.serratec.dto.carrinho.CartCadastroDTO;
...
public class CarrinhoResource {
	...
	@ApiOperation(value = "Finalizar carrinho e fechar pedido.")
	@PostMapping("/cart/finalizar")
	public ResponseEntity<?> postCarrinho(@RequestBody CartCadastroDTO dto) throws ProdutoException, ClienteException, CarrinhoException {

	    Carrinho carrinho = dto.toCarrinho(produtoRepository, clienteRepository);
	    ...
	    try {
	        emailService.enviar("Olá, acabamos de receber o seu pedido. ",
	                "Data de Entrega: " + LocalDate.now().plusDays(15) +" Valor: "+ carrinho.getValorTotal(),
